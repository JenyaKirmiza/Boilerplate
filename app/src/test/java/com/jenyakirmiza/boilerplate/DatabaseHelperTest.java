...
import com.jenyakirmiza.boilerplate.data.local.Db;
import com.jenyakirmiza.boilerplate.data.local.DbOpenHelper;
import com.jenyakirmiza.boilerplate.data.model.Ribot;
import com.jenyakirmiza.boilerplate.test.common.TestDataFactory;
import com.jenyakirmiza.boilerplate.util.DefaultConfig;
...
public class DatabaseHelperTest {
    ...
    public void setRibots() {
        ...
        Cursor cursor = mDatabaseHelper.getBriteDb()
                .query("SELECT * FROM " + Db.RibotProfileTable.TABLE_NAME_AUTHOR);
    ...
    public void getRibots() {
        ...
        mDatabaseHelper.getAuthors().subscribe(result);
        result.assertNoErrors();
